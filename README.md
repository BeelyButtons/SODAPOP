...
- Reviewer case-file foundation: implemented alongside the current workflow, with separate application assertions, authorization results, product determinations, supporting evidence, label-package records, claims, and history; live review integration remains intentionally deferred
...
- Automated verification: 217 routing, rule-coverage, interface, OCR, decision-workflow, case-file, and regression tests passing, plus GitHub Pages production-build and lint checks
